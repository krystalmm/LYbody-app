Instructor.seed do |s|
  ...
  s.instructor_image = File.open("./app/assets/images/instructors/instructor1.png")
  s.has_lesson = true
...
Instructor.seed do |s|
  ...
  s.instructor_image = File.open("./app/assets/images/instructors/instructor2.png")
  s.has_lesson = true
...
Instructor.seed do |s|
  ...
  s.instructor_image = File.open("./app/assets/images/instructors/instructor3.png")
  s.has_lesson = true
...
Instructor.seed do |s|
  ...
  s.instructor_image = File.open("./app/assets/images/instructors/instructor4.png")
  s.has_lesson = true
...
Instructor.seed do |s|
  ...
  s.instructor_image = File.open("./app/assets/images/instructors/instructor5.png")
  s.has_lesson = true
